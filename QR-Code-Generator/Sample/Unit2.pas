...
begin
   ...
   begin
     ...
     WriteBool(OPT,'ScaleOn',CheckBox2.Checked);
     WriteInteger(OPT,'X',SpinEdit4.Value);
     WriteInteger(OPT,'Y',SpinEdit5.Value);
     WriteBool(OPT,'Smooth',CheckBox3.Checked);
     WriteInteger(OPT,'Pixel',RadioGroup2.ItemIndex);
     WriteBool(OPT,'Color',CheckBox4.Checked);
...
begin
  ...
  begin
    ...
    CheckBox2.Checked:=ReadBool(OPT,'ScaleOn',CheckBox2.Checked);
    SpinEdit4.Value:=ReadInteger(OPT,'X',SpinEdit4.Value);
    SpinEdit5.Value:=ReadInteger(OPT,'Y',SpinEdit5.Value);
    CheckBox3.Checked:=ReadBool(OPT,'Smooth',CheckBox3.Checked);
    RadioGroup2.ItemIndex:=ReadInteger(OPT,'Pixel',RadioGroup2.ItemIndex);
    CheckBox4.Checked:=ReadBool(OPT,'Color',CheckBox4.Checked);
