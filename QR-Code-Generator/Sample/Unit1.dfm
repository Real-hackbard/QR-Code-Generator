object Form1: TForm1
  ...
  object Panel2: TPanel
    ...
    object Memo1: TMemo
      ...
      TabStop = False
      Lines.Strings = (
        'https://github.com/Real-hackbard?'
        'tab=repositories')
      TabOrder = 0
    end
  ...
  object SaveDialog1: TSaveDialog
    DefaultExt = 'bmp'
    Filter = 
      'Windows Bitmap file (*.bmp)|*.bmp|JPEG file (*.jpg)|*.jpg|Portab' +
      'le Network Graphic file (*.png)|*.png|Graphics Interchange Forma' +
      't (*.gif)|*.gif|Windows Metafile (*.wmf)|*.wmf|Enhanced Metafile' +
      ' (*.emf)|*.emf'
    Left = 432
    Top = 96
  end
